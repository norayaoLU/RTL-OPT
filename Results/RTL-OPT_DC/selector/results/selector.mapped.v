...
// Date      : Mon May 12 01:45:55 2025
/////////////////////////////////////////////////////////////


module selector ( clk, sel, dout );
  input [3:0] sel;
  output [6:0] dout;
  input clk;
  wire   dout_next_4_, dout_next_2_, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12,
  ...
  DFF_X1 dout_reg_4_ ( .D(dout_next_4_), .CK(clk), .Q(dout[4]) );
  DFF_X1 dout_reg_2_ ( .D(dout_next_2_), .CK(clk), .Q(dout[2]) );
  ...
  XNOR2_X1 U22 ( .A(n3), .B(n10), .ZN(dout_next_2_) );
  XNOR2_X1 U23 ( .A(n29), .B(n28), .ZN(dout_next_4_) );
